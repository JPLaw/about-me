...
function guessSports(){
  while (totalGuesses > 0){
    userAnswer = parseInt(prompt('Can you guess how many sports I played in high school?'));
...
// tally total
// will display closing message like "thanks for playing! you got ____ out of 7 right."
